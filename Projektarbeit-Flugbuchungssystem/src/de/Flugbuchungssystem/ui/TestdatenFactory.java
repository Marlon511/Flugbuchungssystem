...
public class TestdatenFactory {
    ...
    public static void laden(FlughafenRepository flughafenRepo,
        ...
        // --- Flüge: Lufthansa FRA → JFK ---
        Flugzeug fz_lh400 = new Flugzeug("Boeing 747", "D-ABCD", frankfurt, 4, 2, 20, 4, 120, 20);
        lufthansa.addFlugzeug(fz_lh400);
        flugRepo.addFlug(new Flug("LH400", lufthansa, frankfurt, newYork,
                LocalDateTime.of(2026, 6, 14, 10, 0),
                LocalDateTime.of(2026, 6, 14, 20, 30), 499.99, fz_lh400));

        Flugzeug fz_lh402 = new Flugzeug("Boeing 747", "D-ABCE", frankfurt, 4, 2, 20, 4, 120, 20);
        lufthansa.addFlugzeug(fz_lh402);
        flugRepo.addFlug(new Flug("LH402", lufthansa, frankfurt, newYork,
                LocalDateTime.of(2026, 8, 16, 11, 0),
                LocalDateTime.of(2026, 8, 16, 21, 30), 519.99, fz_lh402));

        Flugzeug fz_lh404 = new Flugzeug("Boeing 747", "D-ABCF", frankfurt, 4, 2, 20, 4, 120, 20);
        lufthansa.addFlugzeug(fz_lh404);
        flugRepo.addFlug(new Flug("LH404", lufthansa, frankfurt, newYork,
                LocalDateTime.of(2026, 6, 19, 9, 0),
                LocalDateTime.of(2026, 6, 19, 19, 30), 519.99, fz_lh404));

        // --- Flüge: Lufthansa MUC → FRA ---
        Flugzeug fz_lh200 = new Flugzeug("Airbus A320", "D-EFGH", muenchen, 0, 0, 12, 2, 144, 24);
        lufthansa.addFlugzeug(fz_lh200);
        flugRepo.addFlug(new Flug("LH200", lufthansa, muenchen, frankfurt,
                LocalDateTime.of(2026, 6, 16, 8, 0),
                LocalDateTime.of(2026, 6, 16, 9, 15), 89.99, fz_lh200));

        Flugzeug fz_lh202 = new Flugzeug("Airbus A320", "D-EFGI", muenchen, 0, 0, 12, 2, 144, 24);
        lufthansa.addFlugzeug(fz_lh202);
        flugRepo.addFlug(new Flug("LH202", lufthansa, muenchen, frankfurt,
                LocalDateTime.of(2026, 6, 17, 7, 30),
                LocalDateTime.of(2026, 6, 17, 8, 45), 79.99, fz_lh202));

        Flugzeug fz_lh204 = new Flugzeug("Airbus A320", "D-EFGJ", muenchen, 0, 0, 12, 2, 144, 24);
        lufthansa.addFlugzeug(fz_lh204);
        flugRepo.addFlug(new Flug("LH204", lufthansa, muenchen, frankfurt,
                LocalDateTime.of(2026, 6, 18, 8, 30),
                LocalDateTime.of(2026, 6, 18, 9, 45), 79.99, fz_lh204));

        // --- Flüge: Lufthansa FRA → LHR ---
        Flugzeug fz_lh300 = new Flugzeug("Airbus A320", "D-EFGK", frankfurt, 0, 0, 12, 2, 144, 24);
        lufthansa.addFlugzeug(fz_lh300);
        flugRepo.addFlug(new Flug("LH300", lufthansa, frankfurt, london,
                LocalDateTime.of(2026, 6, 16, 9, 0),
                LocalDateTime.of(2026, 6, 16, 10, 45), 129.99, fz_lh300));

        Flugzeug fz_lh302 = new Flugzeug("Airbus A320", "D-EFGL", frankfurt, 0, 0, 12, 2, 144, 24);
        lufthansa.addFlugzeug(fz_lh302);
        flugRepo.addFlug(new Flug("LH302", lufthansa, frankfurt, london,
                LocalDateTime.of(2026, 6, 17, 14, 0),
                LocalDateTime.of(2026, 6, 17, 15, 45), 119.99, fz_lh302));

        Flugzeug fz_lh304 = new Flugzeug("Airbus A320", "D-EFGM", frankfurt, 0, 0, 12, 2, 144, 24);
        lufthansa.addFlugzeug(fz_lh304);
        flugRepo.addFlug(new Flug("LH304", lufthansa, frankfurt, london,
                LocalDateTime.of(2026, 6, 18, 12, 0),
                LocalDateTime.of(2026, 6, 18, 13, 45), 119.99, fz_lh304));

        // --- Flüge: Emirates DXB → FRA ---
        Flugzeug fz_ek051 = new Flugzeug("Boeing 777", "A6-EDN", dubai, 6, 6, 12, 6, 24, 6);
        emirates.addFlugzeug(fz_ek051);
        flugRepo.addFlug(new Flug("EK051", emirates, dubai, frankfurt,
                LocalDateTime.of(2026, 6, 16, 10, 0),
                LocalDateTime.of(2026, 6, 16, 17, 10), 534.99, fz_ek051));

        Flugzeug fz_ek052 = new Flugzeug("Boeing 777", "A6-EDO", dubai, 6, 6, 12, 6, 24, 6);
        emirates.addFlugzeug(fz_ek052);
        flugRepo.addFlug(new Flug("EK052", emirates, dubai, frankfurt,
                LocalDateTime.of(2026, 6, 17, 15, 0),
                LocalDateTime.of(2026, 6, 17, 22, 10), 534.99, fz_ek052));

        Flugzeug fz_ek053 = new Flugzeug("Boeing 777", "A6-EDP", dubai, 6, 6, 12, 6, 24, 6);
        emirates.addFlugzeug(fz_ek053);
        flugRepo.addFlug(new Flug("EK053", emirates, dubai, frankfurt,
                LocalDateTime.of(2026, 6, 18, 13, 0),
                LocalDateTime.of(2026, 6, 18, 20, 10), 534.99, fz_ek053));

        // --- Flüge: Air France FRA → CDG ---
        Flugzeug fz_af100 = new Flugzeug("Airbus A220", "F-HBIQ", paris, 0, 0, 12, 2, 96, 16);
        airFrance.addFlugzeug(fz_af100);
        flugRepo.addFlug(new Flug("AF100", airFrance, frankfurt, paris,
                LocalDateTime.of(2026, 6, 16, 7, 0),
                LocalDateTime.of(2026, 6, 16, 8, 30), 99.99, fz_af100));

        Flugzeug fz_af102 = new Flugzeug("Airbus A220", "F-HBIR", paris, 0, 0, 12, 2, 96, 16);
        airFrance.addFlugzeug(fz_af102);
        flugRepo.addFlug(new Flug("AF102", airFrance, frankfurt, paris,
                LocalDateTime.of(2026, 6, 17, 16, 0),
                LocalDateTime.of(2026, 6, 17, 17, 30), 109.99, fz_af102));

        Flugzeug fz_af104 = new Flugzeug("Airbus A220", "F-HBIS", paris, 0, 0, 12, 2, 96, 16);
        airFrance.addFlugzeug(fz_af104);
        flugRepo.addFlug(new Flug("AF104", airFrance, frankfurt, paris,
                LocalDateTime.of(2026, 6, 18, 15, 0),
                LocalDateTime.of(2026, 6, 18, 16, 30), 109.99, fz_af104));

        // --- Flüge: Air France CDG → JFK ---
        Flugzeug fz_af200 = new Flugzeug("Airbus A380", "F-HPJA", paris, 6, 3, 24, 4, 24, 6);
        airFrance.addFlugzeug(fz_af200);
        flugRepo.addFlug(new Flug("AF200", airFrance, paris, newYork,
                LocalDateTime.of(2026, 6, 16, 10, 30),
                LocalDateTime.of(2026, 6, 16, 19, 0), 429.99, fz_af200));

        Flugzeug fz_af202 = new Flugzeug("Airbus A380", "F-HPJB", paris, 6, 3, 24, 4, 24, 6);
        airFrance.addFlugzeug(fz_af202);
        flugRepo.addFlug(new Flug("AF202", airFrance, paris, newYork,
                LocalDateTime.of(2026, 6, 17, 11, 0),
                LocalDateTime.of(2026, 6, 17, 19, 30), 449.99, fz_af202));

        Flugzeug fz_af204 = new Flugzeug("Airbus A380", "F-HPJC", paris, 6, 3, 24, 4, 24, 6);
        airFrance.addFlugzeug(fz_af204);
        flugRepo.addFlug(new Flug("AF204", airFrance, paris, newYork,
                LocalDateTime.of(2026, 6, 18, 9, 0),
                LocalDateTime.of(2026, 6, 18, 17, 30), 449.99, fz_af204));

        System.out.println("Testdaten geladen: 6 Flughäfen | 3 Airlines | 15 Flugzeuge | 15 Flüge");
    }
}